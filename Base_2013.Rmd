...
The `doaj_seal.csv` data set will be copied and enhanced with additional columns, reulsting in the processed dataset, `doaj_seal_enhanced.csv`. The following columns will be added to `doaj_seal.csv`, in conformance with the Coding Framework of Castro et al (2017)
